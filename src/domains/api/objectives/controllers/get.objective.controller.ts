...
export class GetObjectiveController implements IGetObjectiveController {
  constructor(private readonly getObjectiveInteractor: GetObjectiveInteractor) {}

  public async getObjectives(request: UserPayload, response: Response): Promise<void> {
    try {
